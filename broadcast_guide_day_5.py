...
DEFAULT_RUN_AT = datetime(2026, 6, 29, 12, 6, tzinfo=MOSCOW_TZ)
BROADCAST_SENT_EVENT = "mini_guide_day_5_sent_2026_06_29_1206"
USER_SEND_DELAY_SECONDS = 0.05

BROADCAST_TEXT = """5️⃣ <b>Отношение к телу и body checking</b>
Неудовлетворённость телом и постоянная «проверка» сильно поддерживают РПП.

<b>Спросите:</b>
🔹 «Насколько ваша самооценка зависит от того, как выглядит ваше тело или какой у вас вес?»
🔹 «Часто ли вы взвешиваетесь, измеряете части тела, разглядываете себя в зеркале или, наоборот, избегаете зеркал и фотографий?»
🔹 «Сравниваете ли вы своё тело с другими, в жизни или в соцсетях, и как это влияет на ваше настроение?»

Обращайте внимание на сильную зависимость самооценки от веса, частые проверки тела или систематическое избегание зеркал."""
...
async def main() -> None:
    parser = argparse.ArgumentParser(
        description="Send mini-guide day 5 broadcast to all RPP bot users."
    )
    parser.add_argument(
        "--now",
        action="store_true",
        help="Send immediately instead of waiting until 2026-06-29 12:06 MSK.",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
